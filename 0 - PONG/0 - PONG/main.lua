...
function love.load()
    ...
    sounds = {
        ...
        ['menu_error'] = love.audio.newSource('sounds/menu_error.wav', 'static'),
...
function love.keypressed(key)
    ...
    elseif key == 'enter' or key == 'return' then
        ...
        if  (gameMode == 'cvc') or (gameMode == 'pvp') or (gameMode == 'pvc' and ((side == 'left' and servingPlayer == 1) or (side == 'right' and servingPlayer == 2))) then
         ...
         elseif  (gameMode == 'pvc') and ((side == 'left' and servingPlayer == 2) 
		 or (side == 'right' and servingPlayer == 1)) then
            if gameState == 'start' then
                gameState = 'serve'
            end
    ...
    if gameState == 'start' then
     ...
     elseif gameState == 'play' then
        ...
        if gameMode == 'pvc' then
         love.graphics.printf(' Side: '..side..' Controls: '..controls, 0, 10, VIRTUAL_WIDTH, 'center')
        end
